...
**Название:** Корректное обновление статуса заказа после ответа платёжного шлюза  
...
**Шаги:**  
1. Выполнить оплату  
2. Дождаться ответа платёжного шлюза  

**Ожидаемый результат:**  
- Статус заказа обновляется в соответствии с полученным результатом  
- Пользователю отображается корректный статус оплаты  
